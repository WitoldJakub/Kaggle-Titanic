...
[4]sex
[5]age
[6]SipSp - number of siblings or sposes aboard
chose by P-values of logistic regression I implemented in R'''
...
# entropy - the function that measurse ot a split 
# we want each node to be homogeneous as much as possioble - reduce entropy
classifier.fit(X, y)
...
out_panda.to_csv('titanic10dt.csv', index = False, header = True, sep = ',')